...
const ProductDetails = () => {
  ...
  const getProducts = async () => {
    const { data } = await axios.get(
      `https://api.escuelajs.co/api/v1/products/${param.id}`
    );
    setProduct(data);
  };
              ...
              <form className="mt-8">
                ...
                <fieldset className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    ...
                    <label for="size_s" className="cursor-pointer">
                      <input
                        type="radio"
                        name="size"
                        id="size_s"
                    ...
                    <label for="size_m" className="cursor-pointer">
                      <input
                        type="radio"
                        name="size"
                        id="size_m"
                    ...
                    <label for="size_l" className="cursor-pointer">
                      <input
                        type="radio"
                        name="size"
                        id="size_l"
                    ...
                    <label for="size_xl" className="cursor-pointer">
                      <input
                        type="radio"
                        name="size"
                        id="size_xl"
